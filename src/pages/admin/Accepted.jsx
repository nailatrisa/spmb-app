...
import { Search, RefreshCw, Loader2, Eye, Printer } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h2 className="text-2xl font-bold text-navy-900">Daftar Diterima</h2>
          <p className="text-sm text-navy-500">Calon siswa yang dinyatakan lolos seleksi</p>
        </div>
                ...
                filteredApplicants.map((app) => (
                  <TableRow key={app.id}>
                    ...
                    <TableCell className="text-right">
                      ...
                      <Link to={`/kartu/${app.registration_number}`} target="_blank">
